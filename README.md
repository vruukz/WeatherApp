A desktop weather application built in C# that pulls real-time weather data from a public API and displays it with a clean, animated interface.
...
<img width="503" height="710" alt="weather" src="https://github.com/user-attachments/assets/55cfad0b-59fc-4348-80d2-d84ee23e5d90" />
